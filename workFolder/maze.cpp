...
void maze::runProgram() {
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        // input
        // -----
        move->processInput(window, playerPosition, cameraPosition, cameraFront, cameraUp, &isJumping, &jumpStartingTime);
...
// ---------------------------------------------------------------------------------------------
void maze::framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
